...
namespace Services
{
    public class BookManager : IBookService
    {
        ...
        {
            var category = await _categoryService.GetOneCategoriesByIdAsync(bookDto.CategoryId, false);
        ...
        public async Task<List<Book>> GetAllBooksAync(bool trackChanges)
        {
            var books = await _manager.Book.GetAllBookAsync(trackChanges);
            return books;
        }

        public async Task<IEnumerable<Book>> GetAllBooksWithDetailAsync(bool trackChanges)
        {
            return await _manager.Book.GetAllBooksWithDetailAsync(trackChanges);
        }
