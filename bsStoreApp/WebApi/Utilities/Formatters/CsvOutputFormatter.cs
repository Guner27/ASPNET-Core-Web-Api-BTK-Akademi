...
{
    //Her Api'nin buna ihtiyacı yok. Bu bölüm sadece CSV formatında çıktı almak için gereklidir. Buna Ek olarak IMvcBuilderExtensions Classı ve Program.cs deki AddCustomCsvFormatter() metodu da bu yapıya dahildir.
